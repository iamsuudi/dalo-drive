...
export default function Home() {
	return (
		<main className="flex min-h-screen flex-col items-center p-5 gap-7 w-full py-20">
			...
			<div className="flex gap-2">
				...
				<Button className="py-6 px-8" variant={"outline"}>Explore More</Button>
			</div>

			<div className="flex p-4 w-screen flex-wrap justify-center gap-5 mt-32">
				<div className="backdrop-blur-sm bg-black/5 max-w-sm space-y-3 p-7 rounded-lg">
